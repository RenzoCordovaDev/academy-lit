...
function compileToLit(scssPath, outJsPath, exportName = 'styles') {
  ...
  // Write to a temporary file first, then rename to avoid partially written module
...
// Resolve paths relative to current working directory so packages can call the script
